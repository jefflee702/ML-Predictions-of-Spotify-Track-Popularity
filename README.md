...
In our data preprocessing steps, we dropped columns with redundant information, searched for null values to remove, and encoded the album name and track genre to allow us to compute correlations through a Seaborn heatmap. We also utilized the default MinMaxScaler to scale our data between 0 and 1.
